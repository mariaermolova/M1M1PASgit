---
title: "Unconditioned MEP Analysis (FDIl)"
...
MEPdata <- read.csv('TSIdata.csv', header=TRUE, sep=',', dec='.')
...
grid.arrange(grobs = list(xy.time,xy.interv,qq.data,hist.data), ncol = 3, nrow = 2)
```
...
write.csv(contrast.summary, file = "contrasts_unconditioned_MEP.csv")
save_kable(contrast_pretty,"contrasts_unconditioned_MEP.txt")
```
